...
/*Function to generate this calendar table*/
...
function calWeekdayRow(){
   ...
   //loop throught the dayName array 
...
function calDays(calDate){
   //deremine the starting day of the month 
   var day = new Date(calDate.getFullYear(), calDate.getMonth(), 1);
   var weekDay = day.getDay();

   // write blank cells prceding the starting day 
   var htmlCode = "<tr>";
