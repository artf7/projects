...
// setting up new date object
var thisDate = new Date();
// making this date object into string 
var dateString = thisDate.toLocaleDateString();

var dateHTML = "<h2>" + dateString + "</h2>";
//getting the specific day of the date
var thisDate = thisDate.getDay();
// runing the getEvent object using "thisDate" as a parameter
var eventHTML = getEvent(thisDate);
